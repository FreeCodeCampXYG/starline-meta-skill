...
This method is bundled into `starline-meta-skill`. Do not check for, download, install, or load another discovery skill.
...
- `adapt`: useful mechanisms that require Starline conventions, different tools, or lighter gates
